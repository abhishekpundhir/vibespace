        ...
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-8 md:mt-0">
            <p className="text-center text-sm text-vibespace-light-text md:text-right">
              &copy; 2025 VibeSpace. All rights reserved.
            </p>
          </div>
        </div>
        
        <div className="mt-8 border-t border-vibespace-border pt-8 md:flex md:items-center md:justify-between">
         
          <div className="flex space-x-8 justify-start md:justify-start md:order-2">
